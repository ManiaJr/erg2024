...
public abstract class Vehicle{
    ...
    public Vehicle(String idioktitis, String arKykloforias, int etosKat, SystimaDieythynsis sysdief, Mihani eng) {
    ...
    public void transferOwnership(String NewIdioktitis){
        System.out.println("Ownership is trasnferred from"+getIdioktitis()+" to "+NewIdioktitis);
        setIdioktitis(NewIdioktitis);
        //idioktitis=NewIdioktitis;
    }
